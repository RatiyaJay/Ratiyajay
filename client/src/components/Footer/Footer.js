        ...
        <footer>
            <div className="footer__container">
                    ...
                    <div className="footer__contact__container">
                        ...
                        <ul className="footer__contacts">
                            <li className="footer__contact">
                                <LocalPhoneIcon /> <span>963867402</span>
                            </li>
                            <li className="footer__contact">
                                <EmailIcon /> <span>GroceryDart@gmil.com</span>
                            </li>
                            <li className="footer__contact">
                                <LocationOnIcon /> <span>Nadiad, gujarat</span>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="fotter__copyright__container">
                    <ul className='nav'>
                        <li className="footer__copyright">©2023 Grocery LTD. |</li>
